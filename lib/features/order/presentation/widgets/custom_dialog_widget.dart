...
class CustomButtonWidget extends StatefulWidget{
  ...
  const CustomButtonWidget({super.key,required this.title, required this.user, required this.product}) ;
  @override
...
class _CustomButton extends State<CustomButtonWidget>{
  ...
  Widget build(BuildContext context) {
   ...
   return Padding(
     ...
     child: ElevatedButton(
         style:  ButtonStyle(
             backgroundColor:
             const WidgetStatePropertyAll(Color.fromARGB(255, 45, 133, 90)),
             foregroundColor: const WidgetStatePropertyAll(Colors.black),
             elevation: const WidgetStatePropertyAll(7),
             shadowColor:
             WidgetStatePropertyAll(Colors.greenAccent.shade200),
  ...
  void showCustomAboutDialog(BuildContext context, String title ,String token , String productID , int productQuantity ,
                ...
                children: [
                 IconButton(onPressed: (){
                   setState(() {
                     ...
                     icon: const Icon(Icons.minimize , size: 10,color: Colors.white,)
                 ) ,
              ...
              [
                ...
                InkWell(
                  onTap: (){
                    ...
                    OrderProductEvent(token: token, productId: productID, quantity: quantity) :
                            AddProductToCartEvent(token: token, productId: productID, quantity: quantity)
                    ) ;
                    Navigator.of(context).pop() ;
                  },
                  child: Text(
